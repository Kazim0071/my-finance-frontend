...
export default function Footer() {
  ...
  return (
    <footer className="w-full border-t border-slate-100 bg-gradient-to-b from-white/95 to-white py-12 lg:py-16">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-5 mb-8">
          ...
          <div className="lg:col-span-2">
            <Link href="/dashboard" className="flex items-center gap-2.5 mb-4">
              <span className="flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-br from-emerald-500 via-emerald-600 to-teal-700 text-white shadow-lg shadow-emerald-500/30">
                <svg
              ...
              <span className="bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-lg font-bold tracking-tight text-transparent">
                Finlytics
              </span>
            </Link>
            ...
            <div className="flex gap-4 mt-6">
              <a href="#" className="inline-flex items-center justify-center h-9 w-9 rounded-lg border border-slate-200 text-slate-600 hover:bg-slate-100 hover:border-slate-300 transition-all duration-200">
